...
int main(void){
	...
	//wiringPiI2CWriteReg8(RTC, HOUR_REGISTER, 0x00+TIMEZONE);
...
void hourInc(void){
	...
	if (interruptTime - lastInterruptTime>200){
		...
		hours = wiringPiI2CWriteReg8(RTC,HOUR_REGISTER,decCompensation(temp));//Write hours back to the RTC
	}
...
void minInc(void){
	...
	if (interruptTime - lastInterruptTime>200){
		...
		mins = wiringPiI2CWriteReg8(RTC,MIN_REGISTER,decCompensation(temp));//Write minutes back to the RTC
